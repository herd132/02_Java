...
public class WhileExample {
	...
	public void ex1() {
		...
		while( input != 0) { // input이 0이 아니면 무한반복, 0이면 멈춤
			...
			switch(input) {
			case 1 : System.out.print("떡볶이를 주문했다."); break;
			case 2 : System.out.print("쫄면을 주문했다."); break;
			case 3 : System.out.print("김밥을 주문했다."); break;
			case 0 : System.out.print("메뉴선택을을 종료합니다..."); break;
